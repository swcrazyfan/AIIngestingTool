...
from video_ingest_tool.steps.analysis.video_analysis import ai_video_analysis_step
...
@patch("os.makedirs")
@patch("video_ingest_tool.steps.analysis.video_analysis._create_ai_summary")
@patch("video_ingest_tool.steps.analysis.video_analysis.os.path.exists", return_value=True)
...
@patch("video_ingest_tool.steps.analysis.video_analysis.HAS_VIDEO_PROCESSOR", False)
